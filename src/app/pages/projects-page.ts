...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="pointer-events-none absolute left-1/2 top-0 h-[420px] w-full -translate-x-1/2 bg-gradient-to-b from-teal-100/60 to-transparent dark:from-teal-900/10"
        aria-hidden="true"
      ></div>
      ...
      <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-16 text-center animate-fade-up">
          <h1 class="mb-6 text-4xl font-extrabold text-gray-900 dark:text-white md:text-5xl">
            Mis
            <span class="relative inline-block text-teal-700 dark:text-teal-300">Proyectos</span>
          </h1>
          <p class="mx-auto max-w-2xl text-lg leading-relaxed text-gray-600 dark:text-gray-400">
            Una colección de mis trabajos más recientes, abarcando desde aplicaciones web
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          @for (project of projects; track project.title; let index = $index) {
            <article
              class="group flex flex-col overflow-hidden rounded-lg border border-teal-900/10 bg-white/90 shadow-lg shadow-teal-950/5 transition-all duration-300 animate-fade-up hover:-translate-y-2 hover:shadow-2xl hover:shadow-teal-500/10 dark:border-teal-300/10 dark:bg-gray-900 dark:hover:shadow-teal-900/10"
            ...
            >
              ...
              >
                ...
                <div
                  class="relative z-10 rounded-lg border border-white/20 bg-white/20 p-3 text-white shadow-inner backdrop-blur-sm"
                >
                  <ng-container
              ...
              <div class="flex flex-1 flex-col p-6">
                <h3
                  class="mb-3 text-xl font-bold text-gray-900 transition-colors group-hover:text-teal-700 dark:text-white dark:group-hover:text-teal-300"
                >
                  {{ project.title }}
                </h3>
                ...
                <div class="mb-6">
                  <div class="flex flex-wrap gap-2">
                    @for (technology of project.technologies; track technology) {
                      <span
                        class="rounded-md border border-gray-200 bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-600 transition-colors group-hover:border-teal-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:group-hover:border-teal-900/50"
                      >
                        {{ technology }}
                      </span>
                    }
...
export class ProjectsPage {
  protected readonly projects: Project[] = [
    ...
    },
    {
      ...
      description:
        'Plataforma de streaming. Desarrollé el frontend consumiendo una API RESTful Java/Spring Boot en la que colaboré activamente.',
