...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(15,118,110,.06)_1px,transparent_1px),linear-gradient(90deg,rgba(15,118,110,.06)_1px,transparent_1px)] [background-size:48px_48px]"
        aria-hidden="true"
      ></div>
      ...
      <div class="relative z-10 mx-auto w-full max-w-7xl">
        <div class="flex flex-col items-center justify-center gap-12 md:flex-row lg:gap-20">
          <div class="group relative flex-shrink-0 animate-fade-left">
            <div
              class="absolute -inset-1 rounded-full bg-gradient-to-tr from-teal-500 to-emerald-300 opacity-25 blur transition duration-500 group-hover:opacity-40"
              aria-hidden="true"
            ></div>
            <div
              class="relative size-64 overflow-hidden rounded-full border-4 border-white/70 shadow-2xl shadow-teal-900/10 dark:border-teal-950/70 md:size-80 lg:size-96"
            >
              <img
          ...
          <div class="max-w-2xl flex-1 space-y-6 text-center md:text-left">
            ...
            <div class="space-y-2">
              ...
              >
                Hola, soy <br />
                <span
                  class="animate-pulse-slow bg-gradient-to-r from-teal-700 via-emerald-600 to-sky-700 bg-clip-text text-transparent dark:from-teal-300 dark:via-emerald-300 dark:to-sky-300"
                >
                  Carlos Alzamora
                </span>
              </h1>
              ...
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                @for (button of socialButtons; track button.name; let index = $index) {
                  ...
                  >
                    ...
                    ></span>
                    <span
                      class="relative transition-transform group-hover:rotate-12 group-hover:scale-110"
                    >
                      <ng-container
    ...
    <ng-template #iconTemplate let-icon="icon">
      @switch (icon) {
        ...
        @case ('message') {
          ...
          >
            <path
              d="M21 11.5a8.38 8.38 0 0 1-1.1 4.1 8.5 8.5 0 0 1-7.4 4.4 8.38 8.38 0 0 1-4.1-1.1L3 21l2.1-5.4A8.38 8.38 0 0 1 4 11.5a8.5 8.5 0 0 1 4.4-7.4A8.38 8.38 0 0 1 12.5 3H13a8.48 8.48 0 0 1 8 8v.5Z"
            />
          </svg>
        }
        @case ('file') {
