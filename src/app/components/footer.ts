...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="absolute left-0 top-0 h-px w-full bg-gradient-to-r from-transparent via-yellow-500/50 to-transparent"
        aria-hidden="true"
      ></div>
      <div
        class="absolute left-1/2 top-0 h-1 w-1/2 -translate-x-1/2 bg-yellow-500/20 blur-[20px]"
        aria-hidden="true"
      ></div>
      ...
      <button
        type="button"
        class="fixed bottom-6 right-6 z-50 rounded-full bg-yellow-500 p-3 text-gray-900 shadow-lg shadow-yellow-500/20 transition-all duration-500 hover:-translate-y-1 hover:scale-110 hover:bg-yellow-400 hover:shadow-yellow-500/40 active:scale-95"
